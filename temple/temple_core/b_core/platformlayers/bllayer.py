...
def createPooja(req):
    ...
    try:
        ...
        comparedResults = constantslayer.createPoojaApi(hashchecksumNdata)
        comparedResults = constantslayer.convinptodict(comparedResults)
        # if(isinstance(comparedResults) == str):compared
        #     comparedResults = json.loads(comparedResults)
        # elif isinstance(comparedResults) != dict:
...
def listPooja(req):
    ...
    try:
        ...
        comparedResults = constantslayer.listTemplePoojaApi(hashchecksumNdata)
    except Exception as exCompareUser:
        maasslogger(request, str(exCompareUser))
        return str(exCompareUser)
    if(comparedResults['result'] == "Success"):
...
def createOfferings(req):
    ...
    try:
        ...
        comparedResults = constantslayer.createOfferingApi(hashchecksumNdata)
        comparedResults = constantslayer.convinptodict(comparedResults)
        # if(isinstance(comparedResults) == str):compared
        #     comparedResults = json.loads(comparedResults)
        # elif isinstance(comparedResults) != dict:
...
def listOfferings(req):
    ...
    try:
        ...
        comparedResults = constantslayer.listTempleOfferingApi(hashchecksumNdata)
    except Exception as exCompareUser:
        maasslogger(request, str(exCompareUser))
        return str(exCompareUser)
    if(comparedResults['result'] == "Success"):
...
def createPrasadam(req):
    ...
    try:
        ...
        comparedResults = constantslayer.createPrasadamApi(hashchecksumNdata)
        comparedResults = constantslayer.convinptodict(comparedResults)
        # if(isinstance(comparedResults) == str):compared
        #     comparedResults = json.loads(comparedResults)
        # elif isinstance(comparedResults) != dict:
...
def listPrasadam(req):
    ...
    try:
        ...
        comparedResults = constantslayer.listTemplePrasadamApi(hashchecksumNdata)
    except Exception as exCompareUser:
        maasslogger(request, str(exCompareUser))
        return str(exCompareUser)
    if(comparedResults['result'] == "Success"):
...
def createDiety(req):
    ...
    try:
        ...
        comparedResults = constantslayer.createDietyApi(hashchecksumNdata)
        comparedResults = constantslayer.convinptodict(comparedResults)
        # if(isinstance(comparedResults) == str):compared
        #     comparedResults = json.loads(comparedResults)
        # elif isinstance(comparedResults) != dict:
...
def listDiety(req):
    ...
    try:
        ...
        comparedResults = constantslayer.listTempleDietyApi(hashchecksumNdata)
    except Exception as exCompareUser:
        maasslogger(request, str(exCompareUser))
        return str(exCompareUser)
    if(comparedResults['result'] == "Success"):
