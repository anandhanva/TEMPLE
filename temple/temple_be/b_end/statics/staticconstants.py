...
create_festivalSchema = {
    ...
    'requestdata': 
     ...
     'fest_name': {'type': 'string'},
     'fest_desc': {'type': 'string'},
     'fest_history': {'type': 'string'}
